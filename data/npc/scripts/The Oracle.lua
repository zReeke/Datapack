...
local config = {
	...
	vocations = {
		["sorcerer"] = {
			...
			{{2120, 1}, {2554, 1}, {18559, 1}, {7620, 1}, {2152, 50}}
		},
		...
		["paladin"] = {
			...
			{{2120, 1}, {2554, 1}, {7618, 1}, {18559, 1}, {2456, 1}, {2544, 50}, {2152, 50}}
		},
		...
		["knight"] = {
			...
			{{8602, 1}, {2439, 1}, {2120, 1}, {18559, 1}, {2554, 1}, {7618, 1}, {2152, 50}}
		}
	}
}
...
local function greetCallback(cid)
	...
	elseif level > 10 then
		npcHandler:say(player:getName() ..", I CAN'T LET YOU LEAVE - YOU ARE TOO STRONG ALREADY! YOU CAN ONLY LEAVE WITH LEVEL 10 OR LOWER.", cid)
		npcHandler:resetNpc(cid)
		return false
...
local function creatureSayCallback(cid, type, msg)
	...
	elseif npcHandler.topic[cid] == 1 then
		...
		if cityTable then
			...
			npcHandler:say("IN WHICH TOWN DO YOU WANT TO LIVE: {CARLIN}, {THAIS}, {ANKRAHMUN}, {EDRON}, {YALAHAR}, {AB'DENDRIEL}, {PORT HOPE}, {DARASHIA} OR {VENORE}.", cid)
		end
