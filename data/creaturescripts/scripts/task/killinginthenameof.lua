local questCreatures =
{
	...
	["pirate buccaneer"] = {questStarted = 1535, questStorage = 65025, creatureStorage = 15058, killsRequired = 3000, raceName = "Pirates"},
	["pirate corsair"] = {questStarted = 1535, questStorage = 65025, creatureStorage = 15059, killsRequired = 3000, raceName = "Pirates"},
	["pirate cutthroat"] = {questStarted = 1535, questStorage = 65025, creatureStorage = 15060, killsRequired = 3000, raceName = "Pirates"},
	["pirate ghost"] = {questStarted = 1535, questStorage = 65025, creatureStorage = 15061, killsRequired = 3000, raceName = "Pirates"},
	["pirate marauder"] = {questStarted = 1535, questStorage = 65025, creatureStorage = 15062, killsRequired = 3000, raceName = "Pirates"},
	["pirate skeleton"] = {questStarted = 1535, questStorage = 65025, creatureStorage = 15063, killsRequired = 3000, raceName = "Pirates"},
	...
	["minotaur mage"] = {questStarted = 1536, questStorage = 65026, creatureStorage = 15071, killsRequired = 5000, raceName = "Minotaurs"},
	["minotaur archer"] = {questStarted = 1536, questStorage = 65026, creatureStorage = 15072, killsRequired = 5000, raceName = "Minotaurs"},
 
	["necromancer"] = {questStarted = 1538, questStorage = 65028, creatureStorage = 15073, killsRequired = 4000, raceName = "Magicians"},
	["priestess"] = {questStarted = 1538, questStorage = 65028, creatureStorage = 15074, killsRequired = 4000, raceName = "Magicians"},
 
	["necromancer"] = {questStarted = 1538, questStorage = 65028, creatureStorage = 15075, killsRequired = 4000, raceName = "Magicians"},
	["priestess"] = {questStarted = 1538, questStorage = 65028, creatureStorage = 15076, killsRequired = 4000, raceName = "Magicians"},

   	["dragon lord"] = {questStarted = 1540, questStorage = 65030, creatureStorage = 15076, killsRequired = 2000, raceName = "Dragons Lord"},
 
	["demon"] = {questStarted = 1539, questStorage = 65029, creatureStorage = 15077, killsRequired = 666, raceName = "Demons"}
}
